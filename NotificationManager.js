...
export function registerListenerWithFCM({onNotificationClickActionHandling}) {
    ...
    switch (type) {
      ...
      case EventType.PRESS:
        ...
        if (detail?.notification?.data) {
          console.log('detail?.notification?.data',detail?.notification?.data)
          onNotificationClickActionHandling(detail?.notification?.data);
        }
        break;
    }
  });
  ...
  messaging().onNotificationOpenedApp(async remoteMessage => {
    ...
    //   onNotificationClickActionHandling(remoteMessage.data);
    // }
  });
